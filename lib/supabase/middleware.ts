...
// dashboard. Keep this lean — it runs on the edge for matched paths.
export async function updateSession(request: NextRequest) {
  ...
  // Gate the dashboard: unauthenticated visitors bounce to /login (with a
  // ?next= so we can return them after sign-in).
